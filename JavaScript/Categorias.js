const categorias=[
    ...
    new Categoria("Decoración-2","decoracion2","moldes-silicona"),
    new Categoria("Mariposas","mariposa","moldes-silicona"),
    new Categoria("Patitas","patita","moldes-silicona"),
    new Categoria("Macetas","maceta","moldes-silicona"),
